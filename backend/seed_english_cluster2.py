...
# PARENT: memorial=child, related=parent. CHILD: memorial=parent, related=child (см. family.py / full-tree).
CHANG_RELATIONSHIPS = [
    ("wei", "ahfong", RelationshipType.PARENT),
    ("ahfong", "wei", RelationshipType.CHILD),
    ("wei", "meilin", RelationshipType.SPOUSE),
    ("meilin", "wei", RelationshipType.SPOUSE),
    ("thomas_chang", "wei", RelationshipType.PARENT),
    ("thomas_chang", "meilin", RelationshipType.PARENT),
    ("wei", "thomas_chang", RelationshipType.CHILD),
    ("meilin", "thomas_chang", RelationshipType.CHILD),
    ("thomas_chang", "alice", RelationshipType.SPOUSE),
    ("alice", "thomas_chang", RelationshipType.SPOUSE),
    ("richard_chang", "thomas_chang", RelationshipType.PARENT),
    ("richard_chang", "alice", RelationshipType.PARENT),
    ("thomas_chang", "richard_chang", RelationshipType.CHILD),
    ("alice", "richard_chang", RelationshipType.CHILD),
    ("richard_chang", "grace", RelationshipType.SPOUSE),
    ("grace", "richard_chang", RelationshipType.SPOUSE),
    ("david_chang", "richard_chang", RelationshipType.PARENT),
    ("david_chang", "grace", RelationshipType.PARENT),
    ("richard_chang", "david_chang", RelationshipType.CHILD),
    ("grace", "david_chang", RelationshipType.CHILD),
    ("david_chang", "jennifer", RelationshipType.SPOUSE),
    ("jennifer", "david_chang", RelationshipType.SPOUSE),
    ("emily_chang", "david_chang", RelationshipType.PARENT),
    ("emily_chang", "jennifer", RelationshipType.PARENT),
    ("david_chang", "emily_chang", RelationshipType.CHILD),
    ("jennifer", "emily_chang", RelationshipType.CHILD),
    ("serena_chang", "david_chang", RelationshipType.PARENT),
    ("serena_chang", "jennifer", RelationshipType.PARENT),
    ("david_chang", "serena_chang", RelationshipType.CHILD),
    ("jennifer", "serena_chang", RelationshipType.CHILD),
...
# Та же семантика PARENT/CHILD, что и Kelly/Anderson.
ROSSI_RELATIONSHIPS = [
    ("enzo", "maria", RelationshipType.SPOUSE),
    ("maria", "enzo", RelationshipType.SPOUSE),
    ("antonio", "enzo", RelationshipType.PARENT),
    ("antonio", "maria", RelationshipType.PARENT),
    ("enzo", "antonio", RelationshipType.CHILD),
    ("maria", "antonio", RelationshipType.CHILD),
    ("antonio", "giulia", RelationshipType.SPOUSE),
    ("giulia", "antonio", RelationshipType.SPOUSE),
    ("marco", "antonio", RelationshipType.PARENT),
    ("marco", "giulia", RelationshipType.PARENT),
    ("antonio", "marco", RelationshipType.CHILD),
    ("giulia", "marco", RelationshipType.CHILD),
    ("marco", "sofia", RelationshipType.SPOUSE),
    ("sofia", "marco", RelationshipType.SPOUSE),
    ("luca", "antonio", RelationshipType.PARENT),
    ("luca", "giulia", RelationshipType.PARENT),
    ("antonio", "luca", RelationshipType.CHILD),
    ("giulia", "luca", RelationshipType.CHILD),
